...
generate_recombination_plots <- function(arg_file, true_rate_file, output_file, 
  ...
  # Display plots
  grid.arrange(g1, g2, g3, g4, ncol = 2, top = paste("Inferred_stage", range_number, 
...
# Example usage:
generate_recombination_plots("fakemap_inferARG_nodes.csv", "same_chr22_500_Ne10000_stage1.csv", 
                             "merged_data_wrongmap_stage4.csv", 
