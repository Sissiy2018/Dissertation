...
# The output from ARG
df = fread("wrongmap4_inferARG_nodes.csv")
head(df)
...
# The true data
df2 <- read.csv2("20Mbrates_chr22_50_Ne1000.csv",sep = ",")
...
grid.arrange(g1, g2, g3, g4, ncol = 2, top = "20Mb_50_Ne10000_inferred (wrong map 4)")
