...
# The true data
df2 <- read.csv2("20Mbrates_chr22_25_Ne10000.csv",sep = ",")
...
grid.arrange(g1, g2, g3, g4, ncol = 2, top = "20Mb_25_Ne10000_exact")

write.csv(merged_df, "merged_data_exact.csv", row.names = FALSE)
